...
<a href="https://github.com/Abdeltoto"><img src="https://readme-typing-svg.demolab.com?font=Inter&weight=600&size=22&duration=3000&pause=2000&color=58A6FF&center=true&vCenter=true&width=600&lines=%F0%9F%91%8B+Hey+everyone!+Welcome+to+my+GitHub!" alt="Hey everyone! Welcome to my GitHub!" /></a>

<img src="frontend/assets/smartsheet-icon.svg" alt="Smartsheet Controller" width="80" />

<br />

# `Talk to Your Smartsheet.`

<h3>Stop clicking. Start talking. Your sheets understand you now.</h3>
...
<br />
<a href="https://github.com/Abdeltoto"><img src="https://readme-typing-svg.demolab.com?font=Inter&weight=500&size=18&duration=3500&pause=1500&color=8B949E&center=true&vCenter=true&width=580&lines=Smartsheet+Lover+%26+Power+User+since+2013;Building+the+future+of+sheet+management;Your+sheets+have+ears+now.+%F0%9F%8E%A7;73+tools.+5+LLMs.+246+green+tests.+%F0%9F%9A%80;Talk+to+your+data.+It+answers+back." alt="Smartsheet Lover & Power User since 2013" /></a>
<br />
...
<img src="frontend/assets/hero-talk-to-sheet.png" alt="Talk to Your Smartsheet — voice-driven AI agent" width="900" />

<br /><br />

[![Smartsheet API](https://img.shields.io/badge/Smartsheet-API%20v2.0-0073EA?style=for-the-badge&logo=data:image/svg+xml;base64,)](https://smartsheet.redoc.ly/)
...
[![+3 LLMs](https://img.shields.io/badge/+3-OpenRouter%20·%20Mistral%20·%20Groq-FF6B6B?style=for-the-badge)](#-bring-your-own-model)
[![MCP](https://img.shields.io/badge/MCP-Protocol-8B5CF6?style=for-the-badge)](https://modelcontextprotocol.io)
[![Tests](https://img.shields.io/badge/tests-246%20green-10B981?style=for-the-badge&logo=pytest&logoColor=white)](#-running-the-test-suite)
...
<img src="frontend/assets/feature-agent-flow.png" alt="Voice → AI → 73 tools → Smartsheet" width="900" />

<sub><i>Voice in. AI in the middle. 73 tools fanning out. Sheet updated.</i></sub>
...
<img src="frontend/assets/feature-multi-ai.png" alt="OpenAI · Anthropic · OpenRouter · Mistral · Groq" width="780" />
...
> **Smartsheet API token** — [app.smartsheet.com](https://app.smartsheet.com/b/home) > Personal Settings > API Access
>
...
<details>
<summary><strong>Account & Navigation</strong> — 10 tools</summary>
...
<details>
<summary><strong>Sheet Reading & Analysis</strong> — 7 tools</summary>
...
<details>
<summary><strong>Data Manipulation</strong> — 6 tools</summary>
...
<details>
<summary><strong>Column Management</strong> — 3 tools</summary>
...
<details>
<summary><strong>Sheet Management</strong> — 5 tools</summary>
...
<details>
<summary><strong>Cross-sheet References</strong> — 2 tools</summary>
...
<details>
<summary><strong>Sharing & Collaboration</strong> — 4 tools</summary>
...
<details>
<summary><strong>Discussions & Comments</strong> — 4 tools</summary>
...
<details>
<summary><strong>Attachments</strong> — 6 tools</summary>
...
<details>
<summary><strong>Update Requests</strong> — 3 tools</summary>
...
<details>
<summary><strong>Proofs (Premium)</strong> — 2 tools</summary>
...
<details>
<summary><strong>Reports & Dashboards</strong> — 4 tools</summary>
...
<details>
<summary><strong>Templates & Webhooks</strong> — 5 tools</summary>
...
<details>
<summary><strong>Automations</strong> — 4 tools</summary>
...
<details>
<summary><strong>Workspace Sharing</strong> — 4 tools</summary>
...
<details>
<summary><strong>Cell Linking & AI</strong> — 3 tools</summary>
...
A complete **[Model Context Protocol](https://modelcontextprotocol.io)** server — plug Smartsheet into Claude Desktop, Cursor, or any MCP client. **52 of the 73 tools are exposed** through MCP (the chat-only ones — `generate_image`, `generate_chart`, etc. — stay in the web app).
...
<img src="frontend/assets/feature-robustness.png" alt="246 green tests across unit, integration and e2e" width="820" />

<sub><i>246 tests · 3 layers · 0 leaks · ~3 min on a laptop.</i></sub>
...
|---|---|---|---|---|
| `unit` | **196** | < 2 s | none | Rate limiter · LLM router · `_friendly_error` (no secrets leaked) · **dispatch contract for all 73 tools** · **agent.run() loop** (confirm, parse-error recovery, `MAX_TOOL_ROUNDS`, image/chart events) · SQLite CRUD · MCP smoke (52 tools registered) |
...
| `e2e` | **9** | medium | Smartsheet | Full FastAPI lifespan · WebSocket handshake · agent loop with stubbed LLM · suggestions extraction · **mid-stream cancel** · **destructive-tool confirm/reject** · **WS rate-limit response** · multi-turn in one connection |
...
- **Health probe** — `GET /health` returns `{"status": "ok", "sessions": N, "uptime": ...}`.
...
| **Smartsheet Learning Center** | [help.smartsheet.com](https://help.smartsheet.com/) |
| **Smartsheet Community** | [community.smartsheet.com](https://community.smartsheet.com/) |
...
<img src="frontend/assets/smartsheet-icon.svg" alt="" width="40" />
